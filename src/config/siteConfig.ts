...
export const pricing = [
  ...
  },
  {
    ...
    items: [
      { name: "Абонемент на 1 месяц", price: "3 300 ₽", duration: "30 дней", description: "Безлимитное посещение", popular: true },
      { name: "Семейный абонемент на 1 месяц", price: "3 000 ₽", duration: "30 дней", description: "Безлимитное посещение для семьи" },
      { name: "Абонемент на 3 месяца", price: "8 000 ₽", duration: "3 месяца", description: "Безлимитное посещение. Продление на 2 недели", savings: "Экономия 1 900 ₽" },
      { name: "Абонемент на 6 месяцев", price: "12 000 ₽", duration: "6 месяцев", description: "Безлимитное посещение. Продление на 1 месяц", savings: "Экономия 7 800 ₽" },
      { name: "Абонемент на 12 месяцев", price: "18 000 ₽", duration: "12 месяцев", description: "Безлимитное посещение. Продление на 2 месяца", savings: "Экономия 21 600 ₽" },
    ],
  },
  {
