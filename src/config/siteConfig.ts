...
export const aboutContent = {
  ...
  paragraphs: [
    "Fitness City — это фитнес-центр с превентивным (целостным) подходом к здоровью. Мы помогаем не просто «потренироваться», а выстроить систему, которая поддерживает энергию, самочувствие и качество жизни.",
    "В основе — гармоничное сочетание физической активности, коррекции питания, психогигиены и работы с дефицитами. Такой комплексный подход помогает улучшать форму и состояние организма мягко и устойчиво.",
    "Мы работаем индивидуально: учитываем ваши цели, уровень подготовки, особенности организма и ограничения. На основе этого подбираем формат тренировок, рекомендации и план, который комфортно встроится в ваш ритм жизни.",
  ],
  trustPoints: [
    {
      icon: "Shield",
